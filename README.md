...
Ensure python3 and flask are installed and that you keep your openai api key safe. Run <code>python3 server.py</code> and open the url in your browser to access locally.